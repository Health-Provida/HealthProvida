...
export default function JoinProviderPage() {
  ...
  const removeFacilityImage = (index) => {
    setFormData(prev => ({
      ...prev, facilityImages: prev.facilityImages.filter((_, i) => i !== index)
    }));
  };
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-teal-50 flex flex-col">
        {/* Minimal header */}
        <header className="w-full bg-white/90 backdrop-blur-md border-b border-gray-100 py-4">
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          ...
          >
            <motion.div
              ...
              className="w-24 h-24 mx-auto mb-8 rounded-full bg-gradient-to-br from-blue-500 to-green-500 flex items-center justify-center shadow-lg shadow-blue-200"
            >
            ...
            >
              <Link
                to="/"
                className="inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-blue-600 to-green-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-green-700 transition-all shadow-md hover:shadow-lg"
              >
                <Home size={18} />
                Return Home
              </Link>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-teal-50 flex flex-col">
              ...
              {STEPS.map((step, idx) => {
                ...
                return (
                  <React.Fragment key={step.id}>
                    {idx > 0 && (
                      <div className={`w-6 h-px mx-0.5 ${isCompleted ? 'bg-blue-400' : 'bg-gray-200'}`} />
                    )}
                    <button
                      onClick={() => goToStep(step.id)}
                      disabled={!isVisited}
                      className={`relative flex items-center gap-2 px-3.5 py-2 rounded-full text-sm font-medium transition-all duration-200
                        ${isActive
            ...
            >
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-gray-500 text-lg">
                      Let's start with the basics so patients can find and contact you.
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        Facility / Practitioner Name <span className="text-red-400">*</span>
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-4 py-3.5 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white"
                        required
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full px-4 py-3.5 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all appearance-none bg-white"
                        required
                      >
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-11 pr-4 py-3.5 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white"
                            required
                          />
                        </div>
                      </div>
              ...
              {currentStep === 2 && (
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-gray-500 text-lg">
                      We'll use this to show your location on the map and help patients find you nearby.
                    </p>
                  </div>

                  {/* Location card — booking.com inspired */}
                  <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    {/* Map-style hero area */}
                    <div className="bg-gradient-to-br from-blue-100 via-green-50 to-teal-100 px-6 py-10 flex flex-col items-center text-center">
                      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-green-500 flex items-center justify-center shadow-lg shadow-blue-200/50 mb-4">
                    ...
                    <div className="p-6 space-y-4">
                      <div>
                        ...
                        <AddressAutocomplete
                          ...
                          required
                          inputClassName="!py-3.5 !rounded-xl !border-gray-200 focus:!ring-blue-500"
                        />
                      </div>
                      ...
                      {formData.latitude && formData.longitude ? (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-green-600 mt-0.5">{formData.address}</p>
                            {formData.city && (
              ...
              {currentStep === 3 && (
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-gray-500 text-lg">
                      Help patients understand your capabilities and specializations.
                    </p>
                  </div>
                    ...
                    {availableHMOs.map((hmo) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={`font-medium text-sm ${selected ? 'text-green-700' : 'text-gray-700'}`}>
                            {hmo}
                          </span>
                        </button>
                      );
                    ...
                    <div className="p-4 bg-green-50 rounded-xl border border-green-200">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {formData.supportedHMOs.map((hmo) => (
                          <span key={hmo} className="px-3 py-1 bg-white text-green-700 rounded-full text-xs font-medium shadow-sm">
                            {hmo}
                          </span>
                        ))}
                      </div>
              ...
              {currentStep === 5 && (
                <div className="space-y-8">
                  <div>
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                      Almost there! Set your hours & add photos
                    </h1>
                    <p className="text-gray-500 text-lg">
                      Let patients know when you're available and show off your facility.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    {formData.facilityImages.length > 0 && (
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-4">
                        {formData.facilityImages.map((img, index) => (
                          <div key={index} className="relative group rounded-xl overflow-hidden shadow-sm border border-gray-100 aspect-[4/3]">
                            <img src={img.preview} alt={`Facility ${index + 1}`} className="w-full h-full object-cover" />
                            <button
                              type="button"
                            ...
                            <div className="absolute bottom-2 left-2 bg-black/40 backdrop-blur-sm text-white text-xs px-2 py-0.5 rounded-md font-medium">
                              {index + 1}
                            </div>
                          </div>
                        ))}
                    ...
                    <label className="cursor-pointer block border-2 border-dashed border-gray-200 rounded-xl p-8 text-center hover:border-blue-400 hover:bg-blue-50/30 transition-all group bg-white">
                      <Upload className="mx-auto w-10 h-10 text-gray-300 mb-3 group-hover:text-blue-400 transition-colors" />
                      <p className="text-gray-600 font-medium text-sm">
                        {formData.facilityImages.length === 0
                          ? 'Click to upload facility photos'
                          : 'Add more photos'}
                      </p>
                      <p className="text-gray-400 text-xs mt-1.5">PNG, JPG, or WebP · Select multiple at once</p>
                      <input type="file" accept="image/*" multiple onChange={handleImageChange} className="hidden" />
                    </label>

                    {formData.facilityImages.length < 4 && (
                      <p className="mt-2.5 text-xs text-amber-600 font-medium flex items-center gap-1.5">
                        <span>⚠</span>
                        At least 4 photos required ({4 - formData.facilityImages.length} more needed)
                      </p>
                    )}
                  </div>
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-gray-100 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
        {/* Progress bar */}
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          {currentStep > 1 ? (
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 text-gray-700 font-semibold rounded-xl hover:bg-gray-100 transition-colors underline underline-offset-4 decoration-gray-300 hover:decoration-blue-600"
            >
              <ArrowLeft size={18} />
              Back
            </button>
          ...
          {currentStep < STEPS.length ? (
            <button
              onClick={handleNext}
              className="flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-blue-600 to-green-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-green-700 transition-all shadow-md hover:shadow-lg active:scale-[0.98]"
            >
              Next
              <ArrowRight size={18} />
            </button>
            ...
            <button
              ...
              disabled={submitting}
              className="flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-blue-600 to-green-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-green-700 transition-all shadow-md hover:shadow-lg active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100"
            >
              {submitting ? (
                <>
